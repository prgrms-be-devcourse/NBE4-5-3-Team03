...
class PostControllerTest {
    ...
    fun createPost() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.nickname").value(expectedPost.nickname))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.title").value(expectedPost.title))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.content").value(expectedPost.content))
    ...
    fun getPostByIdSuccess() {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/posts/$postId"))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.id").value(expectedPost.id))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.title").value(expectedPost.title))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.content").value(expectedPost.content))
    ...
    fun getPostByIdFailure() {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/posts/$postId"))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("해당 Id의 게시글을 찾을 수 없습니다."))
    }
    ...
    fun getPostListAndSearch() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.items.length()").value(postList.size))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.totalPages").value(pageDto.totalPages))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.totalItems").value(pageDto.totalItems))
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.items").isArray())
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.items.length()").value(titleSearchResult.size))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.totalPages").value(titleSearchPageDto.totalPages))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.totalItems").value(titleSearchPageDto.totalItems))
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.items").isArray())
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.items.length()").value(contentSearchResult.size))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.totalPages").value(contentSearchPageDto.totalPages))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.totalItems").value(contentSearchPageDto.totalItems))
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.items").isArray())
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.items.length()").value(nicknameSearchResult.size))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.totalPages").value(nicknameSearchPageDto.totalPages))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.totalItems").value(nicknameSearchPageDto.totalItems))
    ...
    fun postUpdate() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.id").value(updatedPostResponseDto.id))
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.data.userAccountId").value(updatedPostResponseDto.userAccountId)
            )
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.nickname").value(updatedPostResponseDto.nickname))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.title").value(updateRequestDto.title))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.content").value(updateRequestDto.content))
            .andExpect(MockMvcResultMatchers.jsonPath("$.data.isSpoiler").value(updateRequestDto.isSpoiler))
    ...
    fun postDelete() {
        ...
        mockMvc.perform(delete("/api/posts/{id}", postId))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.code").value(HttpStatus.NO_CONTENT.value().toString()))
            .andExpect(MockMvcResultMatchers.jsonPath("$.message").value(HttpStatus.NO_CONTENT.reasonPhrase))
